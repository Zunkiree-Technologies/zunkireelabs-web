...
export default [
  ...
  },
  {
    ...
    category: "Marketing",
    expandedContent: "<div class=\"py-12 md:py-20 py-12 md:py-20\">\n  <section class=\"gap-3\">\n    <h2 class=\"text-4xl md:text-5xl lg:text-6xl font-normal text-gray-900 leading-tight mb-8\">Comparison of AEO and Traditional SEO</h2>\n    <div class=\"text-xs uppercase tracking-widest text-zunkiree-600 font-medium mb-6\"><p>While both AEO and traditional SEO aim to improve content visibility, AEO is specifically focused on AI assistants and their content requirements. This modern approach tailors strategies to be compatible with AI technologies, whereas traditional SEO primarily targets search engine algorithms.</p><table><thead><tr><th>Feature</th><th>Alternative</th><th>Zunkiree Labs</th></tr></thead><tbody><tr><td>Target Audience</td><td>Traditional search engines like Google.</td><td>AI assistants like ChatGPT and Perplexity</td></tr><tr><td>Content Structure</td><td>Emphasis on keyword relevance and backlinking.</td><td>Focus on clear definitions and structured information</td></tr></tbody></table></div>\n  </section>\n</div>"
  },
  {
    id: "nlp",
