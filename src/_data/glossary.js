...
export default [
  ...
  },
  {
    ...
    relatedService: "ai-development",
    category: "AI Fundamentals",
    expandedContent: "<div class=\"container-custom py-12 md:py-20\">\n  <section class=\"gap-3\">\n    <h2 class=\"text-3xl md:text-4xl lg:text-5xl font-normal text-gray-900\">Comparison of Context Windows in AI Models</h2>\n    <div class=\"text-gray-600 leading-relaxed\"><p>When considering different AI models, the size of the context window significantly impacts their performance and capabilities. This aspect is crucial for businesses looking to deploy AI solutions that require extensive text processing. Here are some comparisons regarding the context window provided by Zunkiree Labs and other notable AI models.</p><table><thead><tr><th>Feature</th><th>Alternative</th><th>Zunkiree Labs</th></tr></thead><tbody><tr><td>Context Window Size</td><td>Claude: 200K tokens</td><td>128K tokens</td></tr><tr><td>Use Cases</td><td>Similar use in Claude, potentially better for very lengthy dialogues</td><td>Effective for longer documents and maintaining conversation history</td></tr></tbody></table></div>\n  </section>\n</div>"
  },
  {
