...
export default [
  {
    ...
    expandedContent: "<div class=\"py-12 md:py-20 py-12 md:py-20\">\n  <section class=\"gap-3\">\n    <h2 class=\"text-4xl md:text-5xl lg:text-6xl font-normal text-gray-900 leading-tight mb-8\">Comparison with Traditional Ecommerce</h2>\n    <div class=\"text-xs uppercase tracking-widest text-zunkiree-600 font-medium mb-6\"><p>Agentic commerce offers a significantly different approach to online shopping compared to traditional ecommerce methods, enhancing user experience through automation and AI technology. Understanding these differences can help businesses leverage AI agents effectively.</p><table><thead><tr><th>Feature</th><th>Alternative</th><th>Zunkiree Labs</th></tr></thead><tbody><tr><td>Shopping Method</td><td>Manual browsing and comparison by the user</td><td>Autonomous agents handle the entire buying journey</td></tr><tr><td>Order Processing</td><td>Users complete checkout processes manually</td><td>AI agents execute purchases automatically</td></tr><tr><td>Customer Intent Understanding</td><td>Users must search and filter products themselves</td><td>Natural language processing to understand intent</td></tr></tbody></table></div>\n  </section>\n</div>"
  },
  {
    id: "rag",
