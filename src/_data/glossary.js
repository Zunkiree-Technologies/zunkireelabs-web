...
export default [
  ...
  },
  {
    ...
    relatedService: "ai-development",
    category: "AI Training",
    expandedContent: "<section class=\"py-12 md:py-20\">\n  <div class=\"max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8\">\n    <div class=\"mb-8 last:mb-0\">\n      <h3 class=\"text-xl md:text-2xl font-normal text-gray-900 mb-3\">Zero-shot Learning vs Few-shot Learning</h3>\n      <p class=\"text-gray-600 leading-relaxed\">Zero-shot learning and few-shot learning are two approaches in machine learning that differ primarily in the amount of training data they require.\n\n<ul><li><strong>Zero-shot Learning</strong>: This approach allows an AI model to handle tasks it wasn’t explicitly trained on, without any examples provided. It leverages existing knowledge to make inferences on new tasks.</li><li><strong>Few-shot Learning</strong>: In contrast, few-shot learning involves training the model with a small number of examples for a specific task. While it requires some training data, it significantly reduces the amount compared to traditional methods.</li></ul></p>\n    </div>\n    <div class=\"mb-8 last:mb-0\">\n      <h3 class=\"text-xl md:text-2xl font-normal text-gray-900 mb-3\">Comparison Table: Zero-shot Learning vs Few-shot Learning</h3>\n      <p class=\"text-gray-600 leading-relaxed\">| Feature                        | Zero-shot Learning          | Few-shot Learning           |\n|-------------------------------|-----------------------------|-----------------------------|\n| Training Examples Required     | None                        | Few                         |\n| Flexibility for New Tasks      | High                        | Moderate                    |\n| Performance with Examples       | Generally lower             | Higher                      |\n| Common Use Cases               | Language translation, text classification | Image recognition, specific categorizations |\n| Ideal Scenarios                 | Rapid deployment, versatile applications | When some labeled examples are available |</p>\n    </div>\n  </div>\n</section>"
  },
  {
