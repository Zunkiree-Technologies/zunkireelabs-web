...
export default [
  ...
  },
  {
    ...
    relatedService: "ai-development",
    category: "AI Fundamentals",
    expandedContent: "<div class=\"py-12 md:py-20 py-12 md:py-20\">\n  <section class=\"gap-3\">\n    <h2 class=\"text-4xl md:text-5xl lg:text-6xl font-normal text-gray-900 leading-tight mb-8\">Comparing Context Windows in AI Models</h2>\n    <div class=\"text-xs uppercase tracking-widest text-zunkiree-600 font-medium mb-6\"><p>Understanding the context window is crucial when evaluating different AI models. It influences how much information can be processed at once, which in turn impacts the model's overall performance and usability.</p><table><thead><tr><th>Feature</th><th>Alternative</th><th>Zunkiree Labs</th></tr></thead><tbody><tr><td>Maximum Context Window Size</td><td>200K tokens offered by another model</td><td>128K tokens</td></tr><tr><td>Implication for Processing</td><td>Maintains conversation history and provides extensive context</td><td>Enables processing of longer documents</td></tr></tbody></table></div>\n  </section>\n</div>"
  },
  {
