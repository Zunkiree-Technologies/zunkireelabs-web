...
export default [
  ...
  },
  {
    ...
    relatedService: "ai-development",
    category: "AI Architecture",
    expandedContent: "<div class=\"py-12 md:py-20 py-12 md:py-20\">\n  <section class=\"gap-3\">\n    <h2 class=\"text-4xl md:text-5xl lg:text-6xl font-normal text-gray-900 leading-tight mb-8\">Comparing AI Orchestration with AI Development</h2>\n    <div class=\"text-xs uppercase tracking-widest text-zunkiree-600 font-medium mb-6\"><p>AI Orchestration and AI Development both enhance the functionality of artificial intelligence solutions but focus on different aspects. While orchestration emphasizes coordinating multiple models and tools for complex workflows, development pertains to creating custom AI systems tailored to specific needs. Below are some key differences to consider.</p><table><thead><tr><th>Feature</th><th>Alternative</th><th>Zunkiree Labs</th></tr></thead><tbody><tr><td>Focus</td><td>Building custom AI systems using various methodologies</td><td>Coordinating multiple AI models and services</td></tr><tr><td>Primary Components</td><td>Employs RAG pipelines and LLM integration for tailored solutions</td><td>Utilizes specialized models for different tasks</td></tr><tr><td>Outcome</td><td>Delivers tailored AI solutions for specific business applications</td><td>Improves workflow reliability and enables multi-step reasoning</td></tr></tbody></table></div>\n  </section>\n</div>"
  },
  {
    id: "retrieval-system",
